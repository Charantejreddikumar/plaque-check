          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Access patient queue, review scans, write notes & prescribe treatment.',
                  style: TextStyle(
                ...
                GlassCard(
                  ...
                  opacity: 0.14,
                  borderOpacity: 0.22,
                  glowColor: const Color(0xFF3182CE),
                  child: Form(
                    key: _formKey,
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 24),
                        GlassButton(
                          label: _isLoading ? 'Authenticating Doctor...' : 'Sign In as Doctor',
                  ...
                  child: Column(
                    children: [
                      OutlinedButton.icon(
                        ...
                        icon: const Icon(Icons.medical_information_outlined, color: Color(0xFF3182CE)),
                        label: const Text(
                          'Apply for Doctor Registration',
                          style: TextStyle(color: Color(0xFF3182CE), fontWeight: FontWeight.bold),
                        ),
                      ...
                      const SizedBox(height: 6),
                      Text(
                        'Doctor registrations require Administrator approval before first login',
