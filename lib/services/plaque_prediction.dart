...
class PlaquePrediction {
  ...
  factory PlaquePrediction.fromJson(Map<String, dynamic> json) {
  ...
  int get oralHealthScore => (100 - plaquePercent).clamp(0, 100);
}
...
class ScanReport {
  ...
  factory ScanReport.fromBackendJson(Map<String, dynamic> json) {
    final plaque = (json['plaque_percent'] as num?)?.round() ?? 0;
    return ScanReport(
      imagePath: json['image_path'] as String? ?? '',
      processedImage: json['processed_image'] as String? ?? '',
      date:
  ...
  factory ScanReport.fromLocalJson(Map<String, dynamic> json) {
    return ScanReport(
